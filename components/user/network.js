...
router.post('/', function (req, res) {
  controller.addUser(req.body.userID, req.body.name, req.body.vehiculoId, req.body.cel, req.body.email)
    .then(biciData => {
...
router.put('/:id', function (req, res) {
  controller.updateUser(req.params.id, req.body.userID, req.body.name, req.body.vehiculoId, req.body.cel, req.body.email)
    .then(biciData => {
